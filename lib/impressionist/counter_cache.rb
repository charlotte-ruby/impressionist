module Impressionist
  module CounterCache
    ...
    def set_impressionable_class
      klass = impressionable_type || false
    ...
    def impressionable_find
      exeception_rescuer do
        @entity = impressionable_class.find(impressionable_id)
      end
      @entity
    end
    ...
    def exeception_to_log
      impressionist_log("Couldn't find Widget with id=#{impressionable_id}")
    end
  end
end
